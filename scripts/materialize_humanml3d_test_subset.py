...
materialize a train subset, per docs/DECISIONS.md D-25 / review SUP-20260906-37: the E1A power
check must train on train and evaluate on test, not train-on-test, or a memorisation confound
makes an above-chance R-Precision uninformative about whether the model generalised at all.
